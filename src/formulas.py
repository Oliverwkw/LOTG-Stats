...
_ROWS = [
    ...
    # KTC superflex value (sf_trade_value, matching this 2QB league) of the
    # added / dropped player at four reference points; one row per column.
    {"Stat": "KTC value of player added at deal time", "Sheet": "transactions", "Columns": ["KTC value of player added at deal time"],
     ...
     "Notes": "Sourced from dynasty-daddy's KTC history (matches keeptradecut.com); superflex because the league is 2QB. History back to ≈ April 2021; N/A before that or for an untracked player."},
    {"Stat": "KTC value of player dropped at deal time", "Sheet": "transactions", "Columns": ["KTC value of player dropped at deal time"],
     ...
     "Notes": "N/A for a pure add, an untracked player, or a pre-April-2021 date."},
    ...
    {"Stat": "KTC value of player added at end of season", "Sheet": "transactions", "Columns": ["KTC value of player added at end of season"],
     ...
     "Notes": "N/A for a future season end or pre-history date."},
    {"Stat": "KTC value of player added 1 year later", "Sheet": "transactions", "Columns": ["KTC value of player added 1 year later"],
     ...
     "Notes": "N/A when that date is still in the future."},
    ...
    {"Stat": "KTC value of player dropped at end of season", "Sheet": "transactions", "Columns": ["KTC value of player dropped at end of season"],
     ...
     "Notes": "Shows whether the drop turned out to be a mistake. N/A for a future/pre-history date or a pure add."},
    {"Stat": "KTC value of player dropped 1 year later", "Sheet": "transactions", "Columns": ["KTC value of player dropped 1 year later"],
     ...
     "Notes": "N/A when still in the future or a pure add."},
    ...
    {"Stat": "Net KTC value 1 year later", "Sheet": "transactions", "Columns": ["Net KTC value 1 year later"],
     ...
     "Notes": "Superflex values; N/A inputs treated as 0."},
    ...
    {"Stat": "Player Dropped", "Sheet": "transactions", "Columns": ["Player Dropped"],
     ...
     "Notes": "Hyperlink target to the player's player_all_time row (Phase 11D)."},
    {"Stat": "type of transaction (waiver/free agency)", "Sheet": "transactions",
     "Columns": ["type of transaction (waiver/free agency)"],
    ...
    {"Stat": "Link to next transaction (added player)", "Sheet": "transactions",
     "Columns": ["Link to next transaction (added player)"],
    ...
    {"Stat": "Link to previous transaction (added player)", "Sheet": "transactions",
     "Columns": ["Link to previous transaction (added player)"],
    ...
    {"Stat": "Link to next transaction (dropped player)", "Sheet": "transactions",
     "Columns": ["Link to next transaction (dropped player)"],
    ...
    {"Stat": "Link to previous transaction (dropped player)", "Sheet": "transactions",
     "Columns": ["Link to previous transaction (dropped player)"],
    ...
    },
    {
        ...
        "Notes": "Superflex KTC, depth-taxed; N/A inputs treated per the deal-time rule. Future/pre-history dates are N/A.",
    },
    {
        ...
        "Notes": "Superflex KTC, depth-taxed. N/A when that date is still in the future.",
    },
    {
    ...
    },
    {
        ...
        "Formula": "The deal's SECOND counterparty (only on a 3+ team trade); links to that team's row of the same trade. N/A for a normal 2-team swap.",
    ...
    # --- KTC checkpoints: one row per column (drafted player's KTC superflex value) ---
