...
def build_all(repo_root: Path) -> None:
    ...
    for lg in leagues:
        ...
        playoff_team_count_by_season[season] = _to_int(settings.get("playoff_teams"), None)
...
# Team-week flags & streaks
    ...
    if not tw.empty:
        ...
        for yr, g in tw.groupby("Year"):
            ...
            if not champ and playoff_start and not games_df.empty:
                ...
                if finals_week is not None:
                    ...
                    if not finals_games.empty:
                        ...
                        if not finals_games.empty:
                            champ = _winner_from_row(finals_games.iloc[0])
